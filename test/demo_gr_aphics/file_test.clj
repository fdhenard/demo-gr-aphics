...
(deftest lines->canonical-or-error-maps-test
  (testing "a successful rec and an erroring rec"
...
(deftest canonical->displayable-for-file-processing-test
  (testing "canonical to displayable for file processing transformation"
...
(deftest get-display-sorted-test
  (testing "sorting for file output"
...
;; process-file! is the remainder of the namespace that is not purely functional
;; (side effecting).  The data transformations take place in the pure functions
(deftest process-file-test
  (testing "no errors in side effecting process-file! function"
